...
import { Sun, Moon, ShoppingBag, Menu, X, Instagram, Facebook, MapPin, Phone, MessageCircle } from 'lucide-react';
...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: "₹550/kg",
    image: "https://images.unsplash.com/photo-1589119908995-c6837fa14848?auto=format&fit=crop&q=80&w=800", // Fallback
    category: "Sweets"
  },
  {
    id: 8,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-red-500 rounded-lg flex items-center justify-center text-white font-bold text-xl">S</div>
...
const Hero = () => {
  const whatsappUrl = "https://wa.me/919729588468?text=I%20want%20to%20order%20from%20Shiv%20Shakti%20Confectionery";

  return (
    <section id="home" className="relative min-h-[80vh] flex items-center overflow-hidden bg-white dark:bg-gray-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold text-gray-900 dark:text-white leading-tight mb-6">
            Fresh & Delicious <span className="text-red-500">Sweets</span> Made with Love
          </h1>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed">
            Experience the authentic taste of tradition. From premium Kaju Katli to fresh designer cakes, we bring sweetness to your every celebration.
          </p>
...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  const encodedMsg = encodeURIComponent(`Hello, I want to order ${product.name} from Shiv Shakti Confectionery`);
...
const Products = () => {
  return (
    <section id="products" className="py-24 bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Handcrafted with the finest ingredients and traditional recipes to ensure every bite is a celebration.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl font-display font-bold text-gray-900 dark:text-white mb-6">
              A Legacy of <span className="text-red-500">Sweetness</span> in Safidon
            </h2>
            <div className="space-y-6 text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
                Shiv Shakti Confectionery has been a cornerstone of Safidon's sweet traditions for over two decades. We believe that sweets are more than just food; they are a medium of sharing joy and love.
              </p>
              <p>
                Our master confectioners use only the purest ingredients—fresh milk, premium nuts, and pure desi ghee—to create delicacies that remind you of home. From traditional Indian sweets to modern designer cakes, our quality remains unmatched.
              </p>
              <ul className="space-y-3">
                {['100% Fresh Ingredients', 'Traditional Recipes', 'Hygienic Preparation', 'Customized Orders'].map((item) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-16 bg-red-500 text-white">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">Old Anaj Mandi, Safidon (Jind), Haryana - 126112</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-white/20 rounded-xl">
              ...
              <div className="mt-12 pt-12 border-t border-white/20">
                <p className="text-sm opacity-80 mb-4 uppercase tracking-widest">Follow Us</p>
                <div className="flex gap-4">
                  <a href="#" className="p-3 bg-white/10 hover:bg-white/20 rounded-xl transition-colors">
                    <Instagram size={24} />
                  </a>
                  <a href="#" className="p-3 bg-white/10 hover:bg-white/20 rounded-xl transition-colors">
                    <Facebook size={24} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-red-500 rounded flex items-center justify-center text-white font-bold">S</div>
              <span className="text-xl font-display font-bold text-gray-900 dark:text-white">
                Shiv Shakti <span className="text-red-500">Confectionery</span>
              </span>
            </div>
            <p className="text-gray-500 dark:text-gray-400 max-w-sm mb-6">
              Bringing sweetness to Safidon since 2000. Premium quality sweets, cakes, and snacks for every occasion.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-bold text-gray-900 dark:text-white mb-6">Business Hours</h4>
            <ul className="space-y-4 text-gray-500 dark:text-gray-400">
              <li className="flex justify-between"><span>Mon - Sat:</span> <span>8 AM - 9 PM</span></li>
              <li className="flex justify-between"><span>Sunday:</span> <span>8 AM - 8 PM</span></li>
            </ul>
          </div>
        </div>
